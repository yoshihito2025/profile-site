...
export const generateMetadata = () => {
  return {
    title: "Profile page - yoshihito2025",
    description: "Profile page of yoshihito2025",
  };
};
  ...
  return (
    <>
      <div className={styles.top}>
        <section>
          <h2>
            Welcome to <span>yoshihito2025&apos;s</span> Profile site.
          </h2>
          <p>
...
3D Modeling: Blender`}
          ...
          <section>
            ...
            <ul>
              <li>
                <Link
                  href="https://github.com/yoshihito2025/calculator"
                  target="_blank"
                >
                  Simple calculator
                </Link>
              ...
              <li>
                <Link
                  href="https://github.com/yoshihito2025/realtime-chat-app"
                  target="_blank"
                >
                  Real-time chat
                </Link>
